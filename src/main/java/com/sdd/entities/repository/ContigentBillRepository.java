...
public interface ContigentBillRepository extends JpaRepository<ContigentBill, Long> {
    ...
    List<ContigentBill> findByAuthGroupIdAndStatusAndIsFlag(String groupId, String status, String isFlag);


    List<ContigentBill> findByCbUnitIdInAndFinYearAndBudgetHeadIDOrderByCbDate(List<CgUnit> cgUnits, String finYear, String budgetHeadID);
