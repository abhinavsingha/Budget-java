...
public class BudgetAllocationController {
    ...
    public ResponseEntity<ApiResponse<DefaultResponse>> saveAuthDataRevisionSaveCbAsAllocationData(@RequestBody AuthRequest authRequest) {
        return new ResponseEntity<>(budgetAllocationService.saveAuthDataRevisionSaveCbAsAllocation(authRequest), HttpStatus.OK);
    }

    @GetMapping("/getUnderUnits")
    public ResponseEntity<ApiResponse<List<CgUnit>>> getUnderUnits() {
